...
.carousel .mynav ul li{
    list-style: none;
    border: 3px solid black;
    padding: 2rem 3rem;
    background: rgb(23, 27, 63);
    transition: 0.5s;
}
.carousel .mynav ul li:hover{
    background-color: blue;
    font-size: 20px;
}
.carousel .mynav ul li a{
...
<div class="carousel container">
    <div class="mynav">
        <ul>
        <li>
                <a href="CreateWalletAcount.php" class="add">Create M-Wallet Account</a>
            </li>
            <li>
                <a href="walletadd.php" class="add">M-Wallet <br> Add Amount</a>
            </li>
            <li>
                <a href="walletsend.php" class="send">M-Wallet <br> Send To Card</a>
            </li>
            <li>
                <a href="walletask.php" class="ask">M-Wallet <br> Ask Amount</a>
            </li>
        </ul>
    </div>
</div>
