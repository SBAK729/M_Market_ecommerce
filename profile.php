    ...
    <div class="container-fluid" id="head">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
          <a class="nav-link " href="shewawallet.php">ShewaWallet</a>
          </li>
          <li class="nav-item">
...
<div class="carousel container">
    <div class="mynav">
        <ul>
        <li>
                <a href="change.php" class="add">Change Password</a>
            </li>
            <li>
            <a href="changeuser.php" class="send">Change Username</a>
            </li>
            <li>
            <a href="delete.php" class="ask">Delete Account</a>
            </li>
        </ul>
    </div>
	<div class="container">
